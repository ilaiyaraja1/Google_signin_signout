                    ...
                    auth.signInWithCredential(authCredential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                String phoneNumber = signInAccount.getPhoneNumber();
                                String currentCity = signInAccount.getGivenName(); // or any other available information
                                String dateOfBirth = signInAccount.getFamilyName(); // or any other available information
                                String gender = signInAccount.getGender(); // or any other available information
